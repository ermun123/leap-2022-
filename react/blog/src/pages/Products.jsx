        ...
        <main>
            <div className="container">
                <div className="d-flex justify-content-end mb-4">
                    <label>
                        Хуудаслалт &nbsp;
                        <select className="form-control d-inline-block w-auto" onChange={(e) => setPageSize(e.target.value)} value={pageSize}>
                ...
                <div>
                    <nav aria-label="..." className='my-4'>
                        <ul className="pagination pagination-lg justify-content-center">
                            ...
                            {getPaginations()}
                            <li className={`page-item ${page.page === page.totalPages && 'disabled'}`}>
                                <Link to={`/products?pageSize=${pageSize}&page=${currentPage + 1}`} className="page-link">
                                    ›
                                </Link>
